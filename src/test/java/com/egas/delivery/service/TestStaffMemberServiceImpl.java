...
//		when(gasRepository.findByCustCity(custCity)).thenReturn(Stream.of(new CustomerGasBooking("HTREW2323R","Shruti","Gupta","Maharashtra","Nagpur","Chatrapati Square","9384838332")).collect(Collectors.toList()));
...
//	}	
	...
	{
	  when(gasRepository.findAll()).thenReturn(Stream.of(new CustomerGasBooking("HTREY4565T","Shruti","Gupta","Maharashtra","Nagpur","Chatrapati Square","8346378373")).collect(Collectors.toList())); 
...
//		when(accessoriesRepository.findByCustBookingCity(custBookingCity)).thenReturn(Stream.of(new CustomerAccessoriesBooking("HGTRE2323T","Shrishti","Pandey","Maharashtra","Mumbai","Gandhi Chowk","8364738298","Regulator")).collect(Collectors.toList()));
...
//	}
	...
	{
		when(accessoriesRepository.findAll()).thenReturn(Stream.of(new CustomerAccessoriesBooking("HTREY4565T","Shruti","Gupta","Maharashtra","Nagpur","Chatrapati Square","8346378373","Pipe")).collect(Collectors.toList())); 
	...
	public void testUpdateGasDeliveryStatus()
	{
		...
		when(gasRepository.findByCustPancard("JHTRE2323T")).thenReturn(new CustomerGasBooking("JHTRE2323T","Shruti","Sharma","Maharashtra","Nagpur","Shivaji Chowk","8436472823"));
	...
	public void testUpdateAccessoriesDeliveryStatus()
	{
		...
		when(accessoriesRepository.findByCustPancard("PJAGT5656R")).thenReturn(new CustomerAccessoriesBooking("PJAGT5656R","Shivani","Manchewar","Maharashtra","Mumbai","Nehru Square","7489392292","Regulator"));
